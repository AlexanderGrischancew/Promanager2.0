...
if (isset($_SESSION["AdminBenutzerInfoID"]))
	{
	$BenutzerID = $_SESSION["AdminBenutzerInfoID"];
	}
else
	{
...
if($BenutzerID == $_SESSION["BenutzerID"])
	{
...
$abfrage = "SELECT Name,Vorname,TelefonNr,Ausbildung,Erfahrung,GebDatum,Passwort,Admin FROM Benutzer WHERE BenutzerID ='$BenutzerID';";
...
if ($Admin == 1){$CheckedAdmin = "checked";}else{$CheckedAdmin = "";}
...
<table border cellpadding="100">
	...
	<tr>
		<?php echo "<td>Admin:<label><input type='checkbox' name=Admin[] value='1' $CheckedAdmin /></label></td>" ?>
	</tr>
...
<?php echo "<input type='hidden' name='AdminBenutzerInfoID' value='$BenutzerID'></input>"?>
</form>
